    ...
    <div class="container">
        <div class="block-content">
            <nav class="breadcrumb push">
                ...
                <span class="breadcrumb-item active">User Types</span>
                ...
                @foreach($types as $type)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ url('/admin/userType/edit', ['id' => $type->id]) }}" method="get" style="display: inline-block">
                                <button type="submit" class="btn btn-sm btn-circle btn-alt-info bg-earth-light" title="Edit User">
                                    <i class="fa fa-edit"></i>
                                </button>
                            </form>

                            <form id="deleteForm" action="{{ url('/admin/userType/delete',['id' =>$type->id]) }}" method="post" style="display: inline-block">
