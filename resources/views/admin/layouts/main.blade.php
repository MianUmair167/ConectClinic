            ...
            <div class="block pull-r-l">
                ...
                <div class="block-content">
                    <ul class="nav-users push">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{asset('media/avatars/avatar12.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{asset('media/avatars/avatar7.jpg')}}" alt="">
        ...
        <div class="sidebar-content">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">Spaces</span></a>
                        <ul>
                            <li>
                                <a href="{{ route('spaces') }}">Show Spaces</a>
                            </li>
                            <li>
                                <a href="{{ route('createSpace') }}">Create Spaces</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a class="active" href="{{ route('users') }}"><i class="si si-users"></i><span class="sidebar-mini-hide">Users</span></a>
                    </li>

                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">User Types</span></a>
                        <ul>
                            <li>
                                <a href="{{ route('createUserType') }}">Create User Type</a>
                            </li>
                            <li>
                                <a href="{{ route('userTypes') }}">Show User Types</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">Amenities</span></a>
                        <ul>
                            <li>
                                <a href="{{ route('createAmenity') }}">Create Amenity</a>
                            </li>
                            <li>
                                <a href="{{ route('amenities') }}">Show Amenities</a>
                            </li>
                        </ul>
                    </li>
